...
public class DbUtils { 
	...
	public synchronized Connection getConnection(String contextLookup) {
		...
		if(connection == null) {
			...
			if ( cxt == null ) {
				Logger.getLogger(DbUtils.class.getName()).log(Level.SEVERE, "<" + DbUtils.class.getName() + "> Pas de contexte [javax.naming.InitialContext] pour créer la connexion");
			}
			...
			try {
				...
				Logger.getLogger(DbUtils.class.getName()).log(Level.SEVERE, "<" + DbUtils.class.getName() + "> Impossible de créer [javax.sql.DataSource]");
				e.printStackTrace();
			}
	
			if ( ds == null ) {
				Logger.getLogger(DbUtils.class.getName()).log(Level.SEVERE, "<" + DbUtils.class.getName() + "> Impossible de créer [javax.sql.DataSource]. L'objet n'est pas instancié");
			}
			
			try {
				connection = ds.getConnection();
				Logger.getLogger(DbUtils.class.getName()).log(Level.INFO, "<" + DbUtils.class.getName() + "> Connexion à la base de données réussie");
			} catch (SQLException e) {
				Logger.getLogger(DbUtils.class.getName()).log(Level.SEVERE, "<" + DbUtils.class.getName() + "> La connexion a échoué");
				e.printStackTrace();
			}
		}
		return connection;
